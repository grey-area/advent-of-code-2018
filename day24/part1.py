...
class Group():
    def __init__(self, army_type, id_, build_str):
...
immune = [Group('immune', line_i + 1, line) for line_i, line in enumerate(immune_str.splitlines()[1:])]
infection = [Group('infection', line_i + 1, line) for line_i, line in enumerate(infection_str.splitlines()[1:])]
